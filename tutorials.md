...
2. Get the tutorial data [marieboucher.csv](  https://docs.google.com/spreadsheets/d/1sv2jakoxfNYPtqsQ5kI7SuzDBlW10xMwwiVSNVg2jD4/edit#gid=1326995075) or any other [demo data offered here](https://vistorian.github.io/gettingstarted.html/#demo-datasets).
...
1. Open Google Chrome and get to http://vistorian.net
    ...
    <img src="assets/Images/loadData_2.png" width="100" height="50" style="align:center"> 
...
6. Now, you need to tell the Vistorian how to interpret that data. Therefore, select the corresponding meanings for each column from the dropdown menus above the columns:
    ...
    * Data -> **Time**
    ...
    When you assigning the Date field, Vistorian asks you to specify the time format used in the file. This demo file uses DD/MM/YYYY.
     ...
     <img src="assets/Images/loadData_8.png" width="150" height="100" style="align:center"> 
...
![image](assets/Images/ExtractGeoCord_7.png)
